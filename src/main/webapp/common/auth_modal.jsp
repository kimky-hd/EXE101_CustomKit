                ...
                <div class="w-full md:w-1/2 bg-off-white dark:bg-[#1a1a1a] p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div id="loginPanel" class="space-y-6">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/login" class="space-y-4">
                            ...
                            <button class="bg-primary text-white text-xl font-black px-6 py-3 rounded-xl shadow-hard
                            hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase
                            tracking-tight w-full">Đăng
                                nhập</button>

                            <!-- Google Login Button -->
                            <a href="<%= com.papericious.util.GoogleUtils.getLoginUrl() %>"
                                class="flex items-center justify-center gap-2 bg-white text-doodle-black text-lg font-bold px-6 py-3 rounded-xl border-4 border-doodle-black hover:bg-gray-50 transition-all uppercase tracking-tight w-full mt-2">
