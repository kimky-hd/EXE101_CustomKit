CREATE DATABASE  IF NOT EXISTS `kisskit_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `kisskit_db`;
...
INSERT INTO `contact_message` VALUES (1,NULL,'Nguyễn Văn A','nguyena@example.com','Vấn đề đơn hàng','Đơn hàng #123 của tôi giao lâu quá shop ơi.','NEW','2026-01-20 10:15:35','2026-01-20 10:15:35'),(2,NULL,'Trần Thị B','tranb@example.com','Hợp tác','Mình muốn đặt số lượng lớn cho Workshop.','READ','2026-01-20 10:15:35','2026-01-20 10:15:35');
/*!40000 ALTER TABLE `contact_message` ENABLE KEYS */;
UNLOCK TABLES;

--
-- NEW TABLES FOR FAQ MANAGEMENT
--
...
INSERT INTO `faq_category` (`name`, `description`) VALUES 
('General', 'General questions about the platform'),
('Billing', 'Questions about payments and subscriptions'),
...
INSERT INTO `faq` (`question`, `answer`, `status`, `category_id`, `created_by`) VALUES
('How do I reset my password?', 'Go to settings and click reset password.', 'PUBLISHED', 1, 1),
('Can I change my plan?', 'Yes, anytime from the billing page.', 'DRAFT', 2, 1),
('What browsers are supported?', 'Chrome, Firefox, Safari, and Edge.', 'PUBLISHED', 3, 1);
