                ...
                <div class="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div class="flex flex-col gap-8 lg:pr-10">
                        <div class="relative">
                            ...
                            <p class="text-lg opacity-80 font-medium leading-relaxed max-w-md">
                                Bạn có ý tưởng điên rồ? Muốn đặt workshop riêng? Hay đơn giản là muốn ghé chơi? Chúng
                                mình luôn ở đây!
                            </p>
                        </div>
                        ...
                        <div class="space-y-6 mt-4">
                            ...
                            <div class="flex items-center gap-5 group">
                                ...
                                <div>
                                    <p class="text-sm uppercase tracking-wider font-bold opacity-60 mb-1">Địa chỉ</p>
                            ...
                            <div class="flex items-center gap-5 group">
                                ...
                                <div>
                                    <p class="text-sm uppercase tracking-wider font-bold opacity-60 mb-1">Hotline</p>
                    ...
                    <div class="relative mt-8 lg:mt-0">
                        ...
                        <div
                            ...
                            <h2 class="text-3xl font-black mb-8 text-primary flex items-center gap-2 uppercase italic">
                                                        ...
                                                        <form action="<%=request.getContextPath()%>/contact"
                                                            ...
                                                            <div class="space-y-1">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="${not empty sessionScope.contactName ? sessionScope.contactName : ''}" />
                                                            </div>
                                                            ...
                                                            <div class="space-y-1">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="${not empty sessionScope.contactEmail ? sessionScope.contactEmail : ''}" />
                                                            </div>
                                                                ...
                                                                <div class="relative">
                                                                    <select
                                                                        ...
                                                                        <option value="Order"
                                                                            ...
                                                                            ? 'selected' : '' }>Vấn đề đơn hàng</option>
                                                                        <option value="Collab"
