...
<div id="authModal" class="fixed inset-0 z-50 hidden items-center justify-center px-4">
    <div class="relative w-full max-w-[900px] bg-kraft-brown dark:bg-[#2a2a2a] rounded-lg shadow-2xl overflow-hidden flex flex-col md:flex-row border-[6px] border-doodle-black paper-texture">
        ...
        <div class="w-full md:w-1/2 bg-[#f3e7ea] dark:bg-[#332225] p-12 flex flex-col items-center justify-center relative border-b-4 md:border-b-0 md:border-r-4 border-doodle-black">
            ...
            <div class="mt-8 text-center">
                <h3 class="text-3xl font-black text-doodle-black dark:text-white mb-2 leading-none uppercase tracking-tighter">Ready to Remix?</h3>
                <p class="text-[#974e5d] dark:text-primary font-medium italic">Join the customization revolution.</p>
            </div>
        </div>
        <div class="w-full md:w-1/2 bg-off-white dark:bg-[#1a1a1a] p-8 md:p-12 flex flex-col justify-center">
            <div class="flex items-center justify-between mb-6">
                <div class="flex gap-2">
                    <button id="tabLoginBtn" class="px-4 py-2 font-black uppercase border-2 border-doodle-black rounded-lg bg-primary text-white">Đăng nhập</button>
                    <button id="tabRegisterBtn" class="px-4 py-2 font-black uppercase border-2 border-doodle-black rounded-lg bg-white text-doodle-black">Đăng ký</button>
                </div>
            ...
            <div id="loginPanel" class="space-y-6">
                ...
                <div class="px-4 py-3 rounded-lg border-2 border-red-600 bg-red-50 text-red-700 font-bold"><%= loginError %></div>
                <% } %>
                <form method="post" action="<%=request.getContextPath()%>/login" class="space-y-4">
                    <div>
                        <span class="text-doodle-black dark:text-white text-sm font-bold uppercase tracking-wider ml-1">Email</span>
                        <input name="email" type="email" class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all" placeholder="email@domain.com" />
                    </div>
                    <div>
                        <span class="text-doodle-black dark:text-white text-sm font-bold uppercase tracking-wider ml-1">Mật khẩu</span>
                        <input name="password" type="password" class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all" placeholder="••••••••" />
                    </div>
                    <button class="bg-primary text-white text-xl font-black px-6 py-3 rounded-xl shadow-hard hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight w-full">Đăng nhập</button>
                    <div class="text-sm text-zinc-500">Chưa có tài khoản? <a href="#" class="font-bold text-primary" onclick="switchAuthTab('register'); return false;">Đăng ký</a></div>
                </form>
            </div>
            <div id="registerPanel" class="space-y-6 hidden">
                ...
                <% String registerError = (String) request.getAttribute("registerError"); if (registerError != null) { %>
                <div class="px-4 py-3 rounded-lg border-2 border-red-600 bg-red-50 text-red-700 font-bold"><%= registerError %></div>
                <% } %>
                <form method="post" action="<%=request.getContextPath()%>/register" class="space-y-4">
                    <div>
                        <span class="text-doodle-black dark:text-white text-sm font-bold uppercase tracking-wider ml-1">Họ tên</span>
                        <input name="fullName" type="text" class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all" placeholder="Tên của bạn" />
                    </div>
                    <div>
                        <span class="text-doodle-black dark:text-white text-sm font-bold uppercase tracking-wider ml-1">Email</span>
                        <input name="email" type="email" class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all" placeholder="email@domain.com" />
                    ...
                    <div>
                        <span class="text-doodle-black dark:text-white text-sm font-bold uppercase tracking-wider ml-1">Số điện thoại</span>
                        <input name="phone" type="text" class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all" placeholder="09xxxxxxxx" />
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <span class="text-doodle-black dark:text-white text-sm font-bold uppercase tracking-wider ml-1">Xác nhận</span>
                            <input name="confirmPassword" type="password" class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all" placeholder="••••••••" />
                        </div>
                    </div>
                    <button class="bg-primary text-white text-xl font-black px-6 py-3 rounded-xl shadow-hard hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight w-full">Đăng ký</button>
                    <div class="text-sm text-zinc-500">Đã có tài khoản? <a href="#" class="font-bold text-primary" onclick="switchAuthTab('login'); return false;">Đăng nhập</a></div>
                </form>
            </div>
        </div>
    </div>
...
(function(){
  ...
  var initial = '<%= request.getAttribute("openAuthModal") == null ? "" : (String)request.getAttribute("openAuthModal") %>';
