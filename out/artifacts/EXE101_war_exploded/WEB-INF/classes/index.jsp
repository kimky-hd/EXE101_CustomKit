        ...
        <div id="pageRoot" class="relative flex min-h-screen w-full flex-col overflow-x-hidden pt-24 md:pt-28">
            ...
            <main class="flex-1 flex flex-col items-center justify-center px-6 lg:px-20 py-12 relative">
                ...
                <div class="absolute inset-0 z-0 opacity-10 pointer-events-none overflow-hidden">
                    ...
                    <div class="absolute bottom-20 right-10 -rotate-12 bg-kraft-brown w-32 h-32 rounded-full blur-3xl">
                    </div>
                </div>
                <div class="layout-content-container flex flex-col max-w-[1200px] w-full z-10">
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div class="lg:col-span-7 flex flex-col gap-8 text-left order-2 lg:order-1">
                            <div
                                class="inline-block self-start bg-kraft-brown text-doodle-black px-3 py-1 font-bold text-xs uppercase tracking-widest rounded rotate-[-2deg] shadow-hard">
                            ...
                            <p class="text-xl md:text-2xl font-medium max-w-[500px] leading-snug">
                                Gói trọn yêu thương, Tự tay làm quà. Bộ kit DIY đầy đủ từ màu vẽ chuyên dụng đến cọ tinh
                                xảo.
                            </p>
                            <div class="flex flex-wrap gap-4 mt-4">
                                <button
                                    class="bg-primary text-white text-xl font-black px-10 py-5 rounded-xl shadow-hard-lg hover:translate-x-1 hover:translate-y-1 hover:shadow-hard transition-all uppercase tracking-tight group flex items-center gap-3">
                                ...
                                <div
                                    class="flex items-center gap-2 px-4 py-2 border-2 border-dashed border-doodle-black rounded-lg bg-white/50 dark:bg-background-dark/50">
                        ...
                        <div class="lg:col-span-5 relative order-1 lg:order-2">
                            <div
                                class="relative w-full aspect-square md:aspect-[4/5] bg-white dark:bg-background-dark p-4 doodle-border shadow-hard-lg rotate-[2deg] overflow-hidden">
                                <div class="absolute inset-0 paper-texture opacity-30"></div>
                                <div class="w-full h-full bg-cover bg-center rounded-lg"
                                    data-alt="Flatlay of Kiss Kit with paints, brushes, and kiss marks on white fabric"
                                ...
                                <!-- Floating Stickers -->
                                <div
                                    class="absolute -top-6 -right-6 w-24 h-24 bg-yellow-400 rounded-full flex items-center justify-center border-2 border-doodle-black rotate-12 shadow-hard animate-bounce">
                                    <span class="font-black text-center leading-none text-sm">GIÁ SỐC<br />-30%</span>
                                </div>
                                <div
                                    class="absolute bottom-10 -left-10 bg-white px-4 py-2 border-2 border-doodle-black shadow-hard -rotate-6">
                            ...
                            <!-- Mascot Doodle -->
                            <div
                                class="absolute -bottom-8 -right-8 w-32 h-32 z-20 transition-transform hover:scale-110 cursor-pointer">
                                <div class="relative">
                                    <!-- Placeholder for the doodle cat mascot -->
                                    <div
                                        class="w-full h-full p-2 bg-white rounded-xl border-2 border-doodle-black shadow-hard rotate-[-10deg]">
                                        <div class="w-full h-full bg-contain bg-no-repeat bg-center"
                                            data-alt="Cute doodle cat mascot holding a tiny paintbrush"
                                    ...
                                    <div
                                        class="absolute -top-4 -left-4 bg-primary text-white text-[10px] font-bold px-2 py-1 rounded-full border border-doodle-black">
                                        Hế lô!</div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="px-6 lg:px-20 py-20 bg-kraft-brown/10 border-t-2 border-doodle-black">
                <div class="max-w-[1200px] mx-auto">
                    <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                        <div>
                            <h2 class="text-4xl font-black italic uppercase tracking-tighter">TỪNG CHI TIẾT TRONG
                                KISSKIT GIÚP BẠN VẼ TỐT HƠN</h2>
                            <p class="font-bold opacity-60">Everything you need for a perfect handmade gift.</p>
                        </div>
                        <button class="border-b-4 border-primary font-black hover:text-primary transition-all">XEM CHI
                            TIẾT BỘ KIT</button>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <!-- Feature 1 -->
                        <div
                            class="bg-white dark:bg-background-dark p-6 doodle-border shadow-hard hover:-translate-y-2 transition-transform">
                            <div class="w-full aspect-video bg-cover bg-center rounded mb-4 doodle-border"
                                data-alt="Vibrant acrylic paints in small tubes"
                            ...
                            <p class="text-sm font-medium opacity-80 leading-relaxed">Màu acrylic bền màu, không phai,
                                tuyệt đối an toàn cho làn da nhạy cảm.</p>
                        </div>
                        <!-- Feature 2 -->
                        <div
                            class="bg-white dark:bg-background-dark p-6 doodle-border shadow-hard hover:-translate-y-2 transition-transform rotate-1">
                            <div class="w-full aspect-video bg-cover bg-center rounded mb-4 doodle-border"
                                data-alt="Set of high quality paint brushes"
                                style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuBS0pUIEUad8axRaiYBUZB968hXwJ7ZsFkueq7O_RLWWCk-q7DjjOEwGqifXsevDpOOkSqydGRrF2fH95YBCFXnm-nwgWijkX8GFTmds9JXeEfjJrejKw-7JCwWzsCdmxS_PKmLhbIK5Ct_aAU3YxJV9kwxczx2p53RITHntMGzyJxCim_AkqErRn2moJSkD4YDwpvurBk8DntD96oThj9rMSZyK4_gWNqU74bCiMRpb-v5izEKJR0rAArBlA4a-NanIoP9QqBjK_Y");'>
                            </div>
                            <h3 class="font-black text-xl mb-2 italic">Bộ cọ cao cấp</h3>
                            <p class="text-sm font-medium opacity-80 leading-relaxed">Đa dạng kích thước đầu cọ, giúp
                                bạn đi những nét vẽ tinh xảo nhất.</p>
                        </div>
                        <!-- Feature 3 -->
                        <div
                            class="bg-white dark:bg-background-dark p-6 doodle-border shadow-hard hover:-translate-y-2 transition-transform -rotate-1">
                            <div class="w-full aspect-video bg-cover bg-center rounded mb-4 doodle-border"
                                data-alt="Washi tape and masking tools"
            ...
            <section class="bg-background-light dark:bg-background-dark">
                <div class="px-6 md:px-20 pt-16 pb-8 text-center max-w-[1200px] mx-auto">
                    <span
                        class="bg-yellow-300 text-doodle-black px-4 py-1 font-black uppercase text-sm comic-border sticker-rotate-left inline-block mb-4">
                        The Essentials
                    </span>
                    ...
                    <p class="text-lg md:text-xl font-medium max-w-2xl mx-auto opacity-80">
                        Everything you need to turn your boring basics into wearable art. Hand-picked materials for the
                        Gen Z soul.
                    </p>
                </div>
                <div class="px-6 md:px-20 py-12 max-w-[1200px] mx-auto overflow-hidden">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-4 relative">
                        <div class="md:col-span-5 md:rotate-[-1deg] transition-transform hover:rotate-0">
                            <div
                                class="comic-border bg-white dark:bg-zinc-900 p-6 flex flex-col gap-4 relative comic-border-hover h-full">
                                <div
                                    class="w-full aspect-square bg-zinc-100 rounded-lg overflow-hidden border-2 border-doodle-black">
                                    <div class="w-full h-full bg-center bg-cover"
                                        data-alt="Close up of Mont Marte Crimson Red acrylic paint tube"
                                        style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuAW-5vjtcH71mYZUlVGO5fRDi_Cw9rCGd8voXutEmSeNKtHyclEUOZ5xdyXxXPc_r4YL4sNe9Kf2YvcBPifVQVBpNHoYlcY6Th1PvIrs56_tcNMe6G_w_bREd-j4Uh5liY87Qad37up3oiIjDhEkHPevndIFZjKQ73WwgtSCSUQDHdghTQ_hgSd6IKWP3IhGFFVEbOWY-BjVbWttAk18UM-8PyxkZ8X69R85h-VcLukAiXMlAaTkB8UFKAWtGvPBMnM3v3TH2liKIU");'>
                                    </div>
                                </div>
                                <div
                                    class="absolute -top-4 -right-4 bg-primary text-white px-3 py-1 font-bold text-xs comic-border sticker-rotate-right">
                                    HOT SHADE
                                </div>
                                <div class="mt-2">
                                    <h3 class="text-2xl font-black uppercase text-primary">Đỏ chuẩn son Crimson</h3>
                                    <p class="text-sm font-bold opacity-60 mt-1 uppercase tracking-wider">Mont Marte
                                        Acrylic Paint</p>
                                    <div class="doodle-line w-full my-4"></div>
                                    <p class="text-sm">Siêu pigmented, bám vải cực đỉnh. Một tông đỏ cực cháy không thể
                                        thiếu cho các artist.</p>
                                </div>
                            </div>
                        </div>
                        <div class="md:col-span-7 md:mt-12 md:rotate-[1deg] transition-transform hover:rotate-0">
                            <div
                                class="comic-border bg-[#fff9f0] dark:bg-zinc-800 p-6 flex flex-col md:flex-row gap-6 comic-border-hover h-full relative">
                                <div
                                    class="w-full md:w-1/2 aspect-square bg-zinc-200 rounded-lg overflow-hidden border-2 border-doodle-black shrink-0">
                                    <div class="w-full h-full bg-center bg-cover"
                                        data-alt="Set of three high quality artist brushes"
                                ...
                                <div class="flex flex-col justify-center">
                                    ...
                                    <p class="text-sm font-bold opacity-60 mt-1 uppercase tracking-wider">Set of 3
                                        essential brushes</p>
                                    <div class="doodle-line w-full my-4"></div>
                                    <ul class="text-sm space-y-2">
                                        <li class="flex items-center gap-2"><span
                                                class="material-symbols-outlined text-sm font-bold">check_circle</span>
                                            Fine tip for details</li>
                                        <li class="flex items-center gap-2"><span
                                                class="material-symbols-outlined text-sm font-bold">check_circle</span>
                                            Flat brush for fill</li>
                                        <li class="flex items-center gap-2"><span
                                                class="material-symbols-outlined text-sm font-bold">check_circle</span>
                                            Angled for precision</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="md:col-span-6 md:-mt-4 md:rotate-[0.5deg] transition-transform hover:rotate-0">
                            <div
                                class="comic-border bg-white dark:bg-zinc-900 p-6 flex flex-col gap-4 comic-border-hover h-full">
                                <div
                                    class="w-full aspect-video bg-zinc-100 rounded-lg overflow-hidden border-2 border-doodle-black">
                                    <div class="w-full h-full bg-center bg-cover"
                                        data-alt="A small jar of acrylic medium solvent"
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="text-sm font-bold opacity-60 mt-1 uppercase tracking-wider">The
                                        Medium/Solvent Jar</p>
                                    <div class="doodle-line w-full my-4"></div>
                                    <p class="text-sm">Lớp bảo vệ vô hình giúp thiết kế của bạn bền bỉ qua hàng chục lần
                                        giặt. Không bay màu, không nứt nẻ.</p>
                                </div>
                            </div>
                        </div>
                        <div class="md:col-span-6 md:rotate-[-2deg] transition-transform hover:rotate-0">
                            <div
                                class="comic-border bg-blue-50 dark:bg-zinc-800 p-6 flex flex-col gap-4 comic-border-hover h-full relative">
                                <div
                                    class="absolute top-4 left-4 bg-doodle-black text-white px-2 py-0.5 text-[10px] font-bold uppercase rounded">
                                    Pro Tool
                                </div>
                                <div
                                    class="w-full aspect-video bg-zinc-200 rounded-lg overflow-hidden border-2 border-doodle-black">
                                    <div class="w-full h-full bg-center bg-cover"
                                        data-alt="A roll of blue painter's masking tape"
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="text-sm font-bold opacity-60 mt-1 uppercase tracking-wider">Fox Tape for
                                        precision</p>
                                    <div class="doodle-line w-full my-4"></div>
                                    <p class="text-sm">Băng dính chuyên dụng không để lại keo. Giúp bạn tạo những đường
                                        nét sắc sảo như dân chuyên.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="px-6 md:px-20 py-20 bg-primary/5 text-white mt-12">
                    <div class="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div class="flex flex-col gap-4 border-l-4 border-primary pl-6">
                            ...
                            <p class="text-zinc-400">Designed for the trendsetters and DIY lovers. Pure artistic
                                freedom.</p>
                        </div>
                        <div class="flex flex-col gap-4 border-l-4 border-primary pl-6">
                            ...
                            <p class="text-zinc-400">Only the best materials like Mont Marte and Fox Tape. No cheap
                                fillers.</p>
                        </div>
                    </div>
                </section>
                <section class="px-6 md:px-20 py-24 text-center">
                    <div
                        class="max-w-[800px] mx-auto bg-white dark:bg-zinc-900 comic-border p-12 relative overflow-hidden">
                        ...
                        <p class="text-lg font-medium opacity-80 mb-10">
                            Get your Kiss Kit today and create your unique fashion statement. Free shipping on your
                            first kit!
                        </p>
                        <div class="flex flex-wrap justify-center gap-4">
                            <button
                                class="comic-border bg-primary text-white px-8 py-4 text-lg font-black uppercase comic-border-hover min-w-[200px]">
                                Shop Now
                            </button>
                            <button
                                class="comic-border bg-white text-doodle-black px-8 py-4 text-lg font-black uppercase comic-border-hover min-w-[200px]">
                                View Tutorial
                            </button>
                        </div>
                ...
                <section class="bg-primary/5 px-6 md:px-20 py-16 flex flex-col items-center">
                    <div class="relative inline-block tilt-left mb-8">
                        ...
                        <h1
                            class="bg-white dark:bg-background-dark border-4 border-doodle-black p-6 text-4xl md:text-6xl font-black uppercase tracking-tighter hard-shadow text-center max-w-3xl leading-[0.9]">
                            3 Bước Để Có Chiếc Áo <span class="text-primary italic">Dính Nụ Hôn</span>
                        </h1>
                        <div class="absolute -bottom-6 -right-8">
                            <svg class="fill-current text-doodle-black dark:text-white" height="80"
                                viewBox="0 0 100 100" width="80">
                                <path d="M20,50 Q20,20 50,20 T80,50 T50,80 T20,50" fill="none" stroke="currentColor"
                                    stroke-dasharray="5,5" stroke-width="2"></path>
                                <text font-family="Epilogue" font-size="10" font-weight="bold" x="25" y="55">DIY
                                    MODE</text>
                            </svg>
                        </div>
                    </div>
                ...
                <section class="bg-primary/5 px-6 md:px-20 pb-24">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                        ...
                        <div
                            class="group relative bg-white dark:bg-[#2d1a1d] border-4 border-doodle-black p-4 hard-shadow tilt-right flex flex-col gap-4 z-10 transition-transform hover:-translate-y-2">
                            <div
                                class="absolute -top-5 -left-5 bg-primary text-white w-12 h-12 flex items-center justify-center font-black text-2xl border-4 border-doodle-black rounded-full z-20">
                                1</div>
                            <div class="overflow-hidden border-2 border-doodle-black">
                                <div class="w-full aspect-square bg-center bg-cover transition-transform group-hover:scale-105"
                                    data-alt="Close up of masking tape applied on white fabric creating a square frame"
                                    style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuAPP6idyRW07CTrs1j-gcby6PknWrBgNDWjvOiMR-_Lc1fgULwTfCUjY6x0vGqHpqNRVfXbTTUl1eifxv-B7tr3ouT-Nvi3P8nqIGpHyEokqSG9rv4I95LaIIqmoWKRVdMMAT25BuQw5p7kFywyOLgdRlpgGonNgkCPiDw3P2CYzC0jzF23ThjBTpImeaiJXC5piJG5oTbs86MwTNnwI12aGFHQ1pUKa3F6OqViX4GeqF7r6LmfP-XBC0iZIFtIE36Vvuevq7iSDY8");'>
                                </div>
                            </div>
                            <div class="space-y-2 relative">
                                <h3 class="text-xl font-black uppercase tracking-tight">Dán khung định hình</h3>
                                <p class="text-sm font-medium opacity-80 leading-snug">Dùng băng keo tạo khung nụ hôn
                                    hoàn hảo. Keep it clean!</p>
                                <p class="text-primary font-bold text-xs tracking-widest uppercase italic">Step 1: Tape
                                    Mask</p>
                                <div class="absolute -bottom-2 -right-2 translate-x-4">
                                    <span
                                        class="material-symbols-outlined !text-4xl text-doodle-black dark:text-white">pets</span>
                                </div>
                            </div>
                        </div>
                        <div
                            class="group relative bg-white dark:bg-[#2d1a1d] border-4 border-doodle-black p-4 hard-shadow tilt-left flex flex-col gap-4 z-10 transition-transform hover:-translate-y-2">
                            <div
                                class="absolute -top-5 -left-5 bg-primary text-white w-12 h-12 flex items-center justify-center font-black text-2xl border-4 border-doodle-black rounded-full z-20">
                                2</div>
                            <div class="overflow-hidden border-2 border-doodle-black">
                                <div class="w-full aspect-square bg-center bg-cover transition-transform group-hover:scale-105"
                                    data-alt="Vibrant red acrylic paint being squeezed from a tube onto a palette"
                            ...
                            <div class="space-y-2 relative">
                                ...
                                <p class="text-sm font-medium opacity-80 leading-snug">Mix màu đỏ rực rỡ từ bộ kit hoặc
                                    sáng tạo tone riêng.</p>
                                <p class="text-primary font-bold text-xs tracking-widest uppercase italic">Step 2: Mix
                                    Paint</p>
                                <div class="absolute -bottom-2 -right-2 translate-x-4 scale-x-[-1]">
                                    <span
                                        class="material-symbols-outlined !text-4xl text-doodle-black dark:text-white">brush</span>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="overflow-hidden border-2 border-doodle-black">
                                <div class="w-full aspect-square bg-center bg-cover transition-transform group-hover:scale-105"
                                    data-alt="Finished red kiss lip print on a white t-shirt with glossy finish"
                                    style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuDCjAQWGq_aBmLl9bQtd01IzVnwumtSSd4FKgc9LaeZJ6ZtFjTYiHn0Dt6DlEPEAgAmixOAkbBaTb_c10AOSImF47Cr30DZQp4HJgLEeYJhsCQP0zm5ejqBqrfUsUe4pjRM8cvhpmcVZpSZUPI0yYCNbR-kSzUe3v63HRO3mmgoRYcIVJUES1sj0OrsZRs-0yE2VeunI78UcSNjW1ULgsHqprA4K6jot8JBNQCVo9_b1mYgbka4ySYAV1wNsl-2Q011ZsVvBwEtmWQ");'>
                                </div>
                            </div>
                            <div class="space-y-2 relative">
                                <h3 class="text-xl font-black uppercase tracking-tight">Ấn môi &amp; Phủ bóng</h3>
                                <p class="text-sm font-medium opacity-80 leading-snug">Hoàn thiện tác phẩm của riêng
                                    bạn. Xịt bóng để giữ màu lâu.</p>
                                <p class="text-primary font-bold text-xs tracking-widest uppercase italic">Step 3: Print
                                    &amp; Glaze</p>
                ...
                <!-- CTA Section -->
                <section
                    class="bg-primary px-6 md:px-20 py-20 text-white overflow-hidden relative border-y-8 border-[#1b0e10]">
                    <div
                        class="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
                        <div class="text-center md:text-left">
                            ...
                            <p class="text-lg font-bold opacity-90 italic">Sở hữu ngay bộ Kiss Kit và bắt đầu sáng tạo!
                            </p>
                        </div>
                        <div class="shrink-0">
                            <button
                                class="bg-white text-primary border-4 border-[#1b0e10] px-10 py-5 text-xl font-black uppercase tracking-widest hard-shadow hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all">
                                Mua Ngay
                            </button>
                        </div>
                    </div>
            ...
            <main class="flex-1 max-w-[1200px] mx-auto w-full px-6 py-12">
                ...
                <div class="text-center mb-16 relative">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400 font-handwritten">The crew rocking their custom
                        kiss
                        shirts! 💋✨</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div
                        ...
                        <div class="px-2">
                            <p class="font-handwritten text-xl leading-tight mb-3">Matching with the besties for our
                                road
                                trip! 10/10 vibes.</p>
                            <div class="flex items-center justify-between border-t border-dashed border-gray-200 pt-3">
                    ...
                    <div
                        ...
                        <div class="px-2">
                            <p class="font-handwritten text-xl leading-tight mb-3">No but actually, the quality is
                                insane.
                    ...
                    <div
                        ...
                        <div class="px-2">
                            <p class="font-handwritten text-xl leading-tight mb-3">Cutest anniversary gift idea. He
                                loved it
                                so much! 🥹❤️</p>
                            <div class="flex items-center justify-between border-t border-dashed border-gray-200 pt-3">
                    ...
                    <div
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-300 mb-6">Upload your look and get featured in
                            our
                            hall of fame</p>
                        <button
                    ...
                    <div
                        ...
                        <div class="px-2">
                            <p class="font-handwritten text-xl leading-tight mb-3">Literally cannot stop wearing this.
                                It's
            ...
            <div
                ...
                <div class="w-full md:w-1/2 bg-off-white dark:bg-[#1a1a1a] p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div id="registerPanel" class="space-y-6 hidden">
                        ...
                        <%-- Check for registerError in Session (or Request) --%>
                            <% if (session.getAttribute("registerError") !=null) { %>
                                <div
                                    class="px-4 py-3 rounded-lg border-2 border-red-600 bg-red-50 text-red-700 font-bold">
                                    ${sessionScope.registerError}</div>
                                <% } %>
                                    <form method="post" action="<%=request.getContextPath()%>/register"
                                        ...
                                        <div>
                                            <span
                                                ...
                                                tên</span>
                                            <input name="fullName" value="${sessionScope.regFullName}" type="text"
                                                class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all"
                                        ...
                                        <div>
                                            <span
                                                class="text-doodle-black dark:text-white text-sm font-bold uppercase tracking-wider ml-1">Email</span>
                                            <input name="email" value="${sessionScope.regEmail}" type="email"
                                                class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all"
                                                placeholder="email@domain.com" />
                                        </div>
                                        <div>
                                            <span
                                                ...
                                                điện thoại</span>
                                            <input name="phone" value="${sessionScope.regPhone}" type="text"
                                                class="mt-1 w-full rounded-xl border-4 border-doodle-black bg-white dark:bg-zinc-800 p-4 text-doodle-black dark:text-white focus:ring-0 focus:border-primary placeholder:text-zinc-400 font-medium transition-all"
                                        ...
                                        <div class="text-sm text-zinc-500">Đã có tài khoản? <a href="#"
                                                class="font-bold text-primary"
                                                onclick="switchAuthTab('login'); return false;">Đăng nhập</a></div>
                                    </form>
                    </div>
                </div>
            </div>
            <script>
                    (function () {
                        ...
                        function openAuth(tab) {
                            ...
                            pageRoot.classList.add('page-blur');
                            switchTab(tab || 'login');
                        }
                        ...
                        function closeAuth() {
                            ...
                            pageRoot.classList.remove('page-blur');
                        }
